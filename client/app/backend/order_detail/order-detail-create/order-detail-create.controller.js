...
angular.module('encWechatApp')
  .controller('DashboardOrderDetailCreateCtrl', DashboardOrderDetailCreateCtrl);

function DashboardOrderDetailCreateCtrl($scope, $http, $log, $state, Auth, SweetAlert, Common) {
  var vm = $scope;
  vm.box_title = "创建订餐";
