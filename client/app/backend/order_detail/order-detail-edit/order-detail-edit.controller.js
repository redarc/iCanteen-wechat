...
angular.module('encWechatApp')
  .controller('DashboardOrderDetailEditCtrl', DashboardOrderDetailEditCtrl);

function DashboardOrderDetailEditCtrl($scope, $http, $stateParams, $log, $state, Auth, SweetAlert, Common) {
